...
function buildSystemPrompt(grade, topic, context) {
  const parts = [
    ...
    '',
    'NGUYÊN TẮC BẮT BUỘC:',
    '1. Là "gia sư đồng hành": HƯỚNG DẪN TỪNG BƯỚC, đặt câu hỏi gợi mở, KHÔNG đưa đáp án cuối cùng ngay. Để em tự suy nghĩ trước.',
    '2. CHỈ đưa đáp án cuối cùng khi em đã thử, hoặc khi em xin "xem đáp án" rõ ràng.',
